Ext.define('UiInteraction.controller.UiInteractionController', {
    ...
    views: ['Toolbar', 'TabPanel', 'BaseInfoForm', 'BizInfoForm', 'UiInfoForm'],
    init: function () {
        this.control({
            'baseInfoForm #Name': {
    ...
    onLaunch: function () {
        ...
        if (otype == oType.Add) {
            ...
            var bizNodeInfoForm = me.getBizInfoForm().getForm();
